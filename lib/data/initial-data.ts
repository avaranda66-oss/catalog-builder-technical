...
export const SYSTEM_PRESETS: CatalogPreset[] = [
  {
    ...
    description: 'Layout técnico industrial com header escuro, tipografia metrológica e 3 páginas padrão.',
  ...
  {
    id: 'preset-blank',
    name: 'Catálogo em Branco',
    description: 'Comece do zero com uma única página vazia.',
    design_tokens: {
      colors: {
        primary: '#1A1A2E',
        dark: '#0A0A0A',
    ...
    default_pages: [
      createPage('Página 1', [
        createSection('hero_banner', { title: 'Banner', content: {} }),
        createSection('text_block', { title: 'Descrição', content: { text: 'Insira a descrição do produto aqui.' } }),
      ]),
    ],
    is_system: true,
    created_at: new Date().toISOString(),
