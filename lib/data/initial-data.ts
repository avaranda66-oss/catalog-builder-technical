...
export const SYSTEM_PRESETS: CatalogPreset[] = [
  {
    ...
    name: 'Presys Industrial Premium',
    description: 'Layout técnico industrial com cabeçalho escuro, azul Presys e tipografia metrológica.',
  ...
  {
    id: 'preset-precision-tech',
    name: 'Modern Precision Tech',
    description: 'Estilo moderno azul elétrico para instrumentação de ponta e laboratórios de calibração.',
    design_tokens: {
      colors: {
        primary: '#0284C7',
        dark: '#0F172A',
  ...
  {
    id: 'preset-industrial-gold',
    name: 'Industrial Gold (Fluke Style)',
    description: 'Visual clássico de instrumentação de bancada com detalhes em amarelo industrial e alto contraste.',
    design_tokens: {
      colors: {
        primary: '#D97706',
        dark: '#18181B',
