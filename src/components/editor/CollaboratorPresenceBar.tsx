...
export const CollaboratorPresenceBar: React.FC = () => {
  ...
  return (
    <div className="relative inline-flex items-center no-print" ref={popoverRef}>
      ...
      {isPopoverOpen && (
        <div className="absolute right-0 top-full mt-1.5 w-72 bg-white rounded-lg shadow-xl border border-slate-200 p-3 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
