...
export const OverflowWarningBanner: React.FC<OverflowWarningBannerProps> = ({ result }) => {
  ...
  return (
    <div
      ...
      role="alert"
      className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 no-print editor-only max-w-[92%] shadow-md rounded-none border border-amber-300 bg-amber-50 px-3.5 py-2 text-xs text-amber-900 flex items-center gap-2.5 pointer-events-auto"
    >
