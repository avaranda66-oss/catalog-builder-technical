...
export function mountLegacyApp(root: HTMLElement): void {
  const isA4PhysicalProofRoute = window.location.pathname === '/__a4-physical-proof' && A4PhysicalProofPage;
  const isA4RuntimeBoundaryProofRoute = window.location.pathname === '/__a4-runtime-boundary-proof' && A4RuntimeBoundaryProofPage;
