...
import type { RichText } from './proof-model';
import type { ResolvedStyle } from './proof-style';
...
export function ProofRichText({rich,nowrap=false}:{rich:RichText;nowrap?:boolean}) {
