...
import {
  createW4CTableDocument,
  W4C_CATALOG_ID,
  W4C_OTHER_CATALOG_ID,
} from './w4c-table-document';

const INITIAL_MUTATION_ID = 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa';
const USER_ID = '99999999-9999-4999-8999-999999999999';

function envelope(document: ReturnType<typeof createW4CTableDocument>, revision: number, mutationId: string): CatalogPersistenceEnvelope {
  return {
...
const primary = createW4CTableDocument();
const other = createW4CTableDocument(W4C_OTHER_CATALOG_ID, 'Outro catálogo');
  ...
  interface Window {
    __W4C_PROOF__: {
      state(): {
        ...
        document: unknown;
        cells: Array<{ id: string; rowId: string; columnId: string; content: unknown; style: unknown; presentation: unknown; coveredBy?: string; span?: unknown; annotationIds?: readonly string[] }>;
        frame: unknown;
        canUndo: boolean;
        canRedo: boolean;
        dirty: boolean;
...
window.__W4C_PROOF__ = {
  primaryId: W4C_CATALOG_ID,
  otherId: W4C_OTHER_CATALOG_ID,
  state: () => {
